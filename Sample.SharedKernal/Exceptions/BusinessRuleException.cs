...
namespace Sample.SharedKernal.Exceptions
{
    /// <summary>
    ...
    public class BusinessRuleException : Exception
    {
        ...
        public BusinessRuleException(string ruleName)
            : base(ruleName)/*(string.Format("The {0} business rule is not satisfied.", ruleName))*/
        {
        ...
        public BusinessRuleException(string ruleName, string entityName)
            : base(ruleName)/*string.Format("The {0} business rule is not satisfied in {1} business entity.", ruleName, entityName)*/
        {
            this.RuleName = ruleName;
